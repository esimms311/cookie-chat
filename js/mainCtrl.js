...
$scope.getMessages = function() {
  ...
  //The postMessage function will take whatever the user typed in (hint: look at the html and see what ng-model correlates
  //to on the input box),
...
$scope.postCookie = function() {
  messageService.postCookie().then(function(response){
    $scope.message = ''
  })
}
